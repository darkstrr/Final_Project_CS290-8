  ...
  return (
    <div>
      ...
      <div className="about_section">
        ...
        <p>
          We aim to deliver a real-time music guessing game that can be accessed
          from anywhere as long as you have access to a web browser. Sign in
          with your Google Account to identify yourselves, and then input your
          room code to join in with friends. The game will consist of a music
          preview from a random artist/genre, and 4 choices of songs. By
          selecting one of the choices, the player will be able to earn points
          based on speed and accuracy. The player with the highest amount of
        ...
        <div class="column">
          <div class="card">
            <div class="container">
              ...
              <p>
                <button class="button">
                  <a href="mailto:sa2255@njit.edu">Contact</a>
                </button>
              </p>
            </div>
          </div>
        ...
        <div class="column">
          <div class="card">
            <div class="container">
              ...
              <p>
                <button class="button">
                  <a href="mailto:axw2@njit.edu">Contact</a>
                </button>
              </p>
            </div>
          </div>
        ...
        <div class="column">
          <div class="card">
            <div class="container">
              ...
              <p>
                <button class="button">
                  <a href="mailto:ap223@njit.edu">Contact</a>
                </button>
              </p>
            </div>
          </div>
        ...
        <div class="column">
          <div class="card">
            <div class="container">
              ...
              <p>
                <button class="button">
                  <a href="mailto:mp752@njit.edu">Contact</a>
                </button>
              </p>
            </div>
          </div>
